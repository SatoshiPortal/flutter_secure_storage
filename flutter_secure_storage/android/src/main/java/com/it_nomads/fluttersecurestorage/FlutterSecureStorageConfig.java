...
public class FlutterSecureStorageConfig {
    ...
    private static final Boolean DEFAULT_RECOVERY_MODE = false;
    ...
    public static final String PREF_OPTION_RECOVERY_MODE = "recoveryMode";
    ...
    public FlutterSecureStorageConfig(Map<String, Object> options) {
        ...
        this.recoveryMode = getBooleanOption(options, PREF_OPTION_RECOVERY_MODE, DEFAULT_RECOVERY_MODE);
